...
$(document).on('DOMContentLoaded', function () {
    window.ityped.init(document.querySelector('.ityped'), {
        strings: ['HI THERE!', 'I’M STORM SCHUTTE', 'Your ML/AI Engineer', 'Senior Developer'],
        loop: true
    });
});
...
$(function () {
    $(document).on('click', '.tab-btn-main a', function (e) {
        ...
        // Only affect tabs and content within the same section
        parentSection.find('.tab-btn-main a, .Tabcondent').removeClass('tab-active');
        $(this).addClass('tab-active');
        parentSection.find('#' + tabId).addClass('tab-active');
    });
});
